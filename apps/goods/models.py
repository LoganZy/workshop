...
class GoodsCategory(models.Model):
    ...
    decs = models.TextField(default='',verbose_name='类别描述',help_text='类别描述')
    # 设置目录树的级别
...
class GoodsCategoryBrand(models.Model):
    ...
    decs = models.TextField(default='',max_length=200,verbose_name='品牌描述',help_text='品牌描述')
...
class Goods(models.Model):
    ...
    good_decs = UEditorField(verbose_name=u'内容',imagePath='goods/images/',
                             width=1000,height=300,filePath='goods/files/',default='')
    ship_free = models.BooleanField(default=True,verbose_name='是否承担运费')
    goods_front_iamge = models.ImageField(upload_to='goods/iamges/',null=True,blank=True,verbose_name='封面图')
...
class Banner(models.Model):
    ...
    image = models.ImageField(upload_to='bannner',verbose_name='轮播图片')
